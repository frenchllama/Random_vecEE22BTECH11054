...
\hhline{|-------|}
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{$\myvec{-2.5\\1}$}}
	&\multicolumn{3}{p{	\gnumericColE+%
	\gnumericColF+%
	\gnumericColG+%
	\tabcolsep*2*2}|}%
...
\hhline{|-------|}
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{$\myvec{-4.5\\2}$}}
	&\multicolumn{3}{p{	\gnumericColE+%
	\gnumericColF+%
	\gnumericColG+%
	\tabcolsep*2*2}|}%
...
\hhline{|-------|}
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{$\myvec{1.5\\2}$}}
	&\multicolumn{3}{c|}%
...
\hhline{|-------|}
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{$\myvec{3\\-7}$}}
	&\multicolumn{3}{c|}%
	{\setlength{\gnumericMultiRowLength}{0pt}%
	 \addtolength{\gnumericMultiRowLength}{\gnumericColE}%
	 \addtolength{\gnumericMultiRowLength}{\gnumericColF}%
...
\hhline{|----|~~~}
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{$\myvec{-7\\-3}$}}
	&
	&
	&\multicolumn{1}{p{\gnumericColG}|}%
	{}
...
\hhline{|-------|}
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{$\myvec{-3\\0.33}$}}
	&\multicolumn{3}{p{	\gnumericColE+%
	\gnumericColF+%
	\gnumericColG+%
	\tabcolsep*2*2}|}%
